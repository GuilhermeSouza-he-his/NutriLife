                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Nutricao infantil">Nutrição Infantil</option>
                                <option value="Nutricao estetica">Nutrição Estética</option>
                                <option value="Nutricao funcional">Nutrição Funcional</option>
                                <option value="Nutricao geriatrica">Nutrição Geriátrica</option>
                            </select>
                        </div>
